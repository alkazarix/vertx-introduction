...
import com.talanlabs.sample05.forum.model.ErrorCode;
...
public class TestForumApiVerticle {
    ...
    void deploy_verticle(Vertx vertx, VertxTestContext testContext) {
        databaseService = Mockito.mock(QuestionService.class);
        JsonObject config = new JsonObject().put("listen.port", listenPort);
        vertx.deployVerticle(new ForumApiVerticle(databaseService), new DeploymentOptions().setConfig(config), ar -> {
            if (ar.succeeded()) {
    ...
    void get_questions_success_return_200(Vertx vertx, VertxTestContext testContext) throws Throwable {
        ...
        Mockito.doAnswer(new Answer<AsyncResult<List<Question>>>() {
            @Override
            public AsyncResult<List<Question>>answer(InvocationOnMock invocation) throws Throwable {
                ((Handler<AsyncResult<List<Question>>>) invocation.getArguments()[1]).handle(Future.succeededFuture(questions));
                return null;
            }
    ...
    void get_questions_success_return_hal_response(Vertx vertx, VertxTestContext testContext) throws Throwable {
        ...
        List<Question> questions = new ArrayList<>();
        questions.add(new Question().withUUID(uuid.toString()).withTitle("test").withAuthor("test"));
    ...
    void get_questions_fail_return_500(Vertx vertx, VertxTestContext testContext) throws Throwable {
        ...
        Mockito.doAnswer(new Answer<AsyncResult<List<Question>>>() {
            @Override
            public AsyncResult<List<Question>>answer(InvocationOnMock invocation) throws Throwable {
                ((Handler<AsyncResult<List<Question>>>) invocation.getArguments()[1]).handle(Future.failedFuture(new ReplyException(ReplyFailure.RECIPIENT_FAILURE, ErrorCode.DATABASE_ERROR.getCode(), "fail to fetch")));
                return null;
            }
        }).when(databaseService).list(Mockito.any(), Mockito.any());
    ...
    void get_question_by_id_success_return_200(Vertx vertx, VertxTestContext testContext) throws Throwable {
        ...
        UUID uuid = UUID.randomUUID();
        Question question= new Question().withUUID(uuid.toString()).withAuthor("test").withTitle("test");
        Mockito.doAnswer(new Answer<AsyncResult<Question>>() {
            @Override
            public AsyncResult<Question>answer(InvocationOnMock invocation) throws Throwable {
                ((Handler<AsyncResult<Question>>) invocation.getArguments()[1]).handle(Future.succeededFuture(question));
                return null;
            }
    ...
    void get_question_by_id_success_return_hal_response(Vertx vertx, VertxTestContext testContext) throws Throwable {
        ...
        UUID uuid = UUID.randomUUID();
        Question question = new Question().withUUID(uuid.toString()).withTitle("test").withAuthor("test");
    ...
    void get_question_by_id_fail_return_404(Vertx vertx, VertxTestContext testContext) throws Throwable {
        ...
        Mockito.doAnswer(new Answer<AsyncResult<Question>>() {
            @Override
            public AsyncResult<Question>answer(InvocationOnMock invocation) throws Throwable {
                ((Handler<AsyncResult<Question>>) invocation.getArguments()[1]).handle(Future.failedFuture(new ServiceException(ErrorCode.QUESTION_NOT_FOUND.getCode(), "fail to fetch")));
                return null;
            }
        }).when(databaseService).getById(Mockito.any(), Mockito.any());
    ...
    void get_question_by_id_fail_return_500(Vertx vertx, VertxTestContext testContext) throws Throwable {
        ...
        Mockito.doAnswer(new Answer<AsyncResult<Question>>() {
            @Override
            public AsyncResult<Question>answer(InvocationOnMock invocation) throws Throwable {
                ((Handler<AsyncResult<Question>>) invocation.getArguments()[1]).handle(Future.failedFuture(new ReplyException(ReplyFailure.RECIPIENT_FAILURE, ErrorCode.DATABASE_ERROR.getCode(), "fail to fetch")));
                return null;
            }
        }).when(databaseService).getById(Mockito.any(), Mockito.any());
    ...
    void create_question_fail_return_500(Vertx vertx, VertxTestContext testContext) throws Throwable {
        ...
        Mockito.doAnswer(new Answer<AsyncResult<Question>>() {
            @Override
            public AsyncResult<Question>answer(InvocationOnMock invocation) throws Throwable {
                ((Handler<AsyncResult<Question>>) invocation.getArguments()[1]).handle(Future.failedFuture("fail to create question"));
                return null;
            }
        }).when(databaseService).create(Mockito.any(), Mockito.any());
    ...
    void delete_question_by_id_fail_return_500(Vertx vertx, VertxTestContext testContext) throws Throwable {
        ...
        Mockito.doAnswer(new Answer<AsyncResult<Question>>() {
            @Override
            public AsyncResult<Question>answer(InvocationOnMock invocation) throws Throwable {
                ((Handler<AsyncResult<Question>>) invocation.getArguments()[1]).handle(Future.failedFuture("fail to delete"));
                return null;
            }
        }).when(databaseService).delete(Mockito.any(), Mockito.any());
