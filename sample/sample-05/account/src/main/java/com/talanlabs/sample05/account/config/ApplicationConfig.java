package com.talanlabs.sample05.account.config;
...
public class ApplicationConfig {
    ...
    public static final String PUBLIC_URL_PROPERTY = "public.url";
    ...
    private static final String LISTEN_PORT_ENVIRONMENT = "VERTX_LISTEN_PORT";
    private static final String PUBLIC_URL_ENVIRONMENT = "VERTX_PUBLIC_URL";

    private static final String CONFIG_SYSTEM_PROPERTY = "vertx.config";
    ...
    private ApplicationConfig() {
        ...
        envMapping.put(LISTEN_PORT_ENVIRONMENT, LISTEN_PORT_PROPERTY);
        envMapping.put(PUBLIC_URL_ENVIRONMENT, PUBLIC_URL_PROPERTY);
    }
    ...
    private ConfigRetriever retriever(Vertx vertx) {
        ConfigStoreOptions file = new ConfigStoreOptions()
                .setType("file")
                .setFormat("json")
                .setConfig(new JsonObject().put("path", System.getProperty(CONFIG_SYSTEM_PROPERTY, "conf/config.json")))
                .setOptional(true);
